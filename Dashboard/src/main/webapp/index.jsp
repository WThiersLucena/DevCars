							...
							<div class="card text-white bg-dark mb-3"
								...
								<div class="card-body">
									...
									<p class="card-text">A partir do dia 15/02 (terça-feira)
										estaremos adicionando novos veículos ao nosso catálogo.
										Aguardem novos direcionamentos.</p>
								</div>
							</div>
						</div>
						<div class="col">
							<div class="card text-dark bg-light mb-3"
								...
								<div class="card-body">
									...
									<p class="card-text">Procure pensar sempre no que te
										inspira e use-o como combustível para alcançar seus objetivos.
										E lembre-se: até o maior dos prédios começa no chão.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="table-responsive">
						<table class="table table-striped table-sm">
							...
							<tbody>
								...
								<tr>
									<td>1002</td>
									<td><img alt="" src="guilherme.jpeg" widht="50"
										height="50" style="border-radius: 50px;"></td>
								...
								<tr>
									<td>1005</td>
									<td><img alt="" src="wanderson.jpeg" widht="50"
										height="50" style="border-radius: 50px;"></td>
