        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <form action="ServletAgendamento" method="post">
                <button class="btn btn-primary mb-3" type="submit">ver agendamentos</button>
            </form>
          </div>
        </div>
      </div>
		...
		<table class="table table-striped table-sm table-bordered" >
			<thead>
				<tr class="row">
					...
					<th class="col-2">Taxa de Agendamento</th>
				</tr>
			</thead>
			...
			<tbody>
				<c:forEach var="a" items="${agenda}">
					<tr class="row">
						<td class="col-1"><c:out value="${a.cod_agendamento}" /> 
						...
						<td class="col-1"><fmt:formatDate value="${a.data_reserva}" pattern="dd/MM/yyyy"/></td>					
						<td class="col-2">R$ <fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${a.taxa_agendamento}" /></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
