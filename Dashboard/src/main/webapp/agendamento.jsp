						...
						<table class="table table-striped table-sm table-bordered">
							...
							<tbody>
								<c:forEach var="a" items="${agenda}">
									<tr class="row">
										<td class="col-1 text-center"><c:out
												value="${a.cod_agendamento}" /> <input type="hidden"
											name="id" value="${a.cod_agendamento}" /></td>

										<td class="col"><p>DETALHES DO VEÍCULO:
											<p>
												<c:out value="${a.marca_veiculo}" />
										...
										<td class="col">
											...
											<p>
												CPF/CNPJ:
												<c:out value="${a.numero_documento}" />
											</p>
										...
										<td class="col-1 text-center"><fmt:formatDate
												value="${a.data_reserva}" pattern="dd/MM/yyyy" /></td>
										<td class="col-2 text-center">R$ <fmt:formatNumber
												type="number" maxFractionDigits="2" minFractionDigits="2"
												value="${a.taxa_agendamento}" /></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
