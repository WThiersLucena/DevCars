...
public class Cliente {
	...
	public Cliente(String cod_cliente, String nome_cliente, String razao_social, String numero_documento,
			String email_cliente, Date data_nascimento, String telefone_cliente) {
		super();
	...
	public String toString() {
		return "Cliente [cod_cliente=" + cod_cliente + ", nome_cliente=" + nome_cliente + ", razao_social="
				...
				+ ", data_nascimento=" + data_nascimento + ", telefone_cliente=" + telefone_cliente + "]";
	}
...
//
//	public Cliente(String cod_cliente, String nome_cliente, String razao_social, String email_cliente,
//			Date data_nascimento, String telefone_cliente) {
//		// TODO Auto-generated constructor stub
//	}
//
//
